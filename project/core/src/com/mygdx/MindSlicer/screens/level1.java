...
public class level1 implements Screen {
    ...
    public level1(com.mygdx.MindSlicer.Main host) {
        com.mygdx.MindSlicer.Main.save();
        com.mygdx.MindSlicer.defaultValues.levelInd = 1;
        this.host = host;
        skin = host.skin;
        ...
        winner = com.mygdx.MindSlicer.Main.getLevelText("winner1");
        ...
        player = new com.mygdx.MindSlicer.playerActor(1);
        enemy = new com.mygdx.MindSlicer.enemyActor(1);
        ...
        kid = new com.mygdx.MindSlicer.kidActor(1);
    ...
    private void openingDialog() {
        String introduceKid = com.mygdx.MindSlicer.Main.getLevelText("kid1");
    ...
    public void loseWinCheck() {
        ...
        if(enemy.ENEMY_HEALTH <= 0){
            com.mygdx.MindSlicer.defaultValues.level1Defeated = true;
            enemy.enemyDie();
            kid.appear();
    ...
    public void dispose() {
        ...
        com.mygdx.MindSlicer.Main.fightMusic.dispose();
        skin.dispose();
    }
}
