...
public class playerActor extends Actor {
    ...
    public static int MONEY = com.mygdx.MindSlicer.defaultValues.startingMoney;
    ...
    public playerActor(int level) {
        ...
        PLAYER_ATK = com.mygdx.MindSlicer.defaultValues.currentAttack;
        PLAYER_DEF = com.mygdx.MindSlicer.defaultValues.currentDefence;
    ...
    public void hitAction() {
        ...
        if (currentLevel == 1) {
            com.mygdx.MindSlicer.screens.level1.enemy.reduceHealth(PLAYER_ATK);
        } else if (currentLevel == 2) {
            com.mygdx.MindSlicer.screens.level2.enemy.reduceHealth(PLAYER_ATK);
        } else if (currentLevel == 3) {
            level3.enemy.reduceHealth(PLAYER_ATK);
        }

        playerActionDone = true;
        com.mygdx.MindSlicer.enemyActor.allowPlayerAttack = false;
        enemyAttacksAfter = 4;
    }
