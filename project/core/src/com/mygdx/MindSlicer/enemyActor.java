...
public class enemyActor extends Actor {
    ...
    public void enemyHit() {
        ...
        if(currentLevel == 1) {
            com.mygdx.MindSlicer.screens.level1.player.reduceHealth(ENEMY_ATK);
        } else if (currentLevel == 2) {
            com.mygdx.MindSlicer.screens.level2.player.reduceHealth(ENEMY_ATK);
        } else if (currentLevel == 3) {
            com.mygdx.MindSlicer.screens.level3.player.reduceHealth(ENEMY_ATK);
        }
    ...
    public void majorAttack() {
        ...
        if (currentLevel == 1) {
            ...
            com.mygdx.MindSlicer.screens.level2.player.reduceHealth(50);
        } else if (currentLevel == 3) {
            com.mygdx.MindSlicer.screens.level3.player.reduceHealth(50);
        }
    ...
    public void allowPlayerToAttack(int delay) {
        Timer.schedule(new Timer.Task() {
            ...
            public void run() {
                ...
                if(currentLevel == 1) {
                    com.mygdx.MindSlicer.screens.level1.playerTurnTeller();;
                } else if (currentLevel == 2) {
                    com.mygdx.MindSlicer.screens.level2.playerTurnTeller();;
                } else if (currentLevel == 3) {
                    com.mygdx.MindSlicer.screens.level3.playerTurnTeller();;
                }
