...
import com.mygdx.MindSlicer.buttons.settingsIngameButton;
...
public class level3 implements Screen {
    ...
    public level3(com.mygdx.MindSlicer.Main host) {
        com.mygdx.MindSlicer.Main.save();
        com.mygdx.MindSlicer.defaultValues.levelInd = 3;
        this.host = host;
        skin = host.skin;
        ...
        winner = com.mygdx.MindSlicer.Main.getLevelText("winner3");
        ...
        player = new com.mygdx.MindSlicer.playerActor(3);
        enemy = new com.mygdx.MindSlicer.enemyActor(3);
        actionbutton = new com.mygdx.MindSlicer.buttons.actionButton();
        ...
        kid = new com.mygdx.MindSlicer.kidActor(3);
    ...
    private void openingDialog() {
        String introduceKid = com.mygdx.MindSlicer.Main.getLevelText("kid3");
    ...
    public void loseWinCheck() {
        ...
        if(enemy.ENEMY_HEALTH <= 0){
            com.mygdx.MindSlicer.defaultValues.level3Defeated = true;
            enemy.enemyDie();
            kid.appear();
